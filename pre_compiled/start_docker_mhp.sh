...
docker run -it -p 9999:9999 -d -v $workdir/wallet:/opt/mhservice/wallet -v $workdir/settings.json.$net:/opt/mhservice/settings.json -v $workdir/leveldb:/opt/mhservice/leveldb -v $workdir/blocks:/opt/mhservice/blocks $docker_image
